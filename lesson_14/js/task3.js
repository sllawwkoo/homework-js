...
const totalCost = dataList.reduce(
...
const reducedCount = dataList.reduce(
	(prevCount, product) =>
		product.price < product.old_price ? prevCount + 1 : prevCount,
	0
);
...
const availableProducts = dataList.reduce(
	(availableList, product) =>
...
const availableProductsList = availableProducts.map((product) => ({
	id: product.id,
	price: product.price,
	old_price: product.old_price,
	usd_price: product.usd_price,
}));
console.log("availableProductsList = ", availableProductsList);
